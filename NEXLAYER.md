...
**Live:** [https://relaxed-weasel-core.cloud.nexlayer.ai](https://relaxed-weasel-core.cloud.nexlayer.ai)  
...
**core** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01kece1xyh817dwff7wnarhkxd/core:19f21468186"
      path: /
      servicePorts:
        - 80
      vars: {}
